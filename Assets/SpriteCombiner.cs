...
namespace CatchCo
{
    ...
    //To use, grab all sprites you want to combine under a  gameobject parent,attach this script to the parent and click combine
    //Note combining generates a mesh and copies uvs and and uses materials to draw the mesh. not using sprite renderer
    //TODO, add a finialize button, check if parent has no child object, dont combine
